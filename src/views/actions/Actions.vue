<template>
  <h2>Action movies list:</h2>
  <div v-for="action in actions" :key="action.id" class="actionStyle">
  <router-link :to="{ name: 'ActionDetails', params: { id: action.id }}">
   <h2> {{ action.title }}</h2>
  </router-link>
  </div>
</template>
...
.actionStyle:not(:disabled) {
  box-shadow: rgba(60, 64, 67, .3) 0 1px 3px 0, rgba(60, 64, 67, .15) 0 4px 8px 3px;
}

.actionStyle:not(:disabled):hover {
  box-shadow: rgba(60, 64, 67, .3) 0 2px 3px 0, rgba(60, 64, 67, .15) 0 6px 10px 4px;
}

.actionStyle:not(:disabled):focus {
  box-shadow: rgba(60, 64, 67, .3) 0 1px 3px 0, rgba(60, 64, 67, .15) 0 4px 8px 3px;
}

.actionStyle:not(:disabled):active {
